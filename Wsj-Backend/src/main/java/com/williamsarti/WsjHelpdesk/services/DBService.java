package com.williamsarti.WsjHelpdesk.services;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "William Sarti", "550.482.150-95", "williamsarti@mail.com",
				encoder.encode("123"));
		tec1.addPerfil(Perfil.ADMIN);
		Tecnico tec2 = new Tecnico(null, "Rodolfo Jesus", "903.347.070-56", "rodcel@mail.com", encoder.encode("123"));
		Tecnico tec3 = new Tecnico(null, "Guilherme Rodriges", "271.068.470-54", "shannon@mail.com",
				encoder.encode("123"));
